...
async def cmd_start(message: Message, config: Config) -> None:
    ...
    await message.answer(
        ...
        "🛍 <b>DevShop</b> — IT-магазин техники, аксессуаров и лицензий. "
        "Всё оформляется прямо здесь, в Telegram.\n\n"
        "🗂 Что в каталоге:\n"
        "• 🖥 Техника — ноутбуки, моноблоки, мониторы\n"
        "• ⌨️ Аксессуары — клавиатуры, мыши, наушники\n"
        "• 💾 Лицензии — Windows, Office, облако\n\n"
        "🛒 Как сделать заказ:\n"
        "1️⃣ Нажмите «Открыть магазин»\n"
        "2️⃣ Соберите корзину и оформите заказ\n"
        "3️⃣ Следите за статусом в разделе «Мои заказы»\n\n"
